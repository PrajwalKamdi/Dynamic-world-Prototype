    ...
    <div className="max-w-7xl m-5">
      <div className="bg-gray-100 px-5 lg:px-8 py-5 rounded-2xl">
        <div className=" md:flex-row md:justify-between md:items-center mb-8">
          ...
          <div>
            <div>
              <h3 className="text-lg lg:text-xl font-bold my-5">
                Top Law Colleges in Pune
              </h3>
              <div className="overflow-x-auto border border-gray-200 rounded-lg">
                <table className="min-w-full divide-y divide-gray-200">
                  <thead className="px-6 py-3 text-left text-sm font-semibold uppercase tracking-wide bg-[#3E96F4] ">
                    <tr>
                      <th className="px-6 py-3 text-left text-sm lg:text-base font-semibold uppercase tracking-wide text-white">
                        College
                      </th>
                      <th className="px-6 py-3 text-left text-sm lg:text-base font-semibold uppercase tracking-wide text-white">
                        Feature
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {lawColleges.map((item, index) => (
                      ...
                      >
                        <td className="px-6 py-4 whitespace-nowrap text-sm lg:text-base text-left  font-medium text-gray-900">
                          {item.college}
                        </td>
                        <td className="px-6 py-4 text-sm lg:text-base text-left text-gray-700">
                          {item.feature}
                        </td>
                      </tr>
                    ))}
            ...
            <div>
              <h3 className="text-lg lg:text-xl my-5  font-bold">
